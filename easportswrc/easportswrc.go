...
var (
	...
	Stages = map[float64]StageID{
		...
		21780.54296875:    {1, 1},
		11371.871094:      {1, 2},
		3630.523193359375: {1, 8}, // old
		// 2:México
		27065.39453125:   {2, 0},
		6154.95751953125: {2, 10}, // old
		7242.689453125:   {2, 11}, // old
		// 3:Croatia
		25884.58203125:   {3, 0},
		8101.09228515625: {3, 8},
		9099.501953125:   {3, 10}, // old
		// 4:Portugal
		30647.3671875:   {4, 0}, // old
		31512.115234375: {4, 1}, // old
		// 5:Sardegna
		31854.994140625: {5, 0},
		7790.3369140625: {5, 10}, // old
		7818.212890625:  {5, 11},
		// 6:Kenya
		5753.6005859375:  {6, 2}, // old
		4848.55517578125: {6, 4}, // fixed
		// 7:Estonia
		17430.73828125:  {7, 0},
		17420.412109375: {7, 1}, // new
		// 8:Finland
		11414.5859375:    {8, 0},
		10670.9384765625: {8, 9}, // new
		// 9:Greece
		24990.927734375:  {9, 0},
		...
		15770.38671875:  {11, 3},  // old
		9173.345703125:  {11, 6},  // old
		9098.77734375:   {11, 7},  // old
		15078.583984375: {11, 8},  // old
		9267.7421875:    {11, 10}, // old
		8979.5126953125: {11, 11}, // old
		// 12:Japan
		20209.443359375:  {12, 0}, // new
		6734.7861328125:  {12, 6},
		7184.89013671875: {12, 11}, // old
		// 13:Mediterraneo
		7982.541015625:  {13, 5}, // new
		9752.8134765625: {13, 9}, // old
		// 14:Pacifico
		5712.67041015625: {14, 7},  // old
		6709.298828125:   {14, 8},  // fix
		9444.4287109375:  {14, 11}, // new
		// 15:Oceania
		7023.32177734375: {15, 2},
		9625.2822265625:  {15, 9}, // old
		// 16:Scandia
		31230.755859375: {16, 0}, // old
		32164.1796875:   {16, 1}, // new
		// 17:Iberia
		19315.458984375: {17, 0}, // new
		10075.623046875: {17, 3}, // old
	}
)
